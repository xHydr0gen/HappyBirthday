...
void t1(){
	fadeStringIn( "Anh co mot mon qua gui tang", 16, 12, 50);
	Sleep(3000);
	fadeStringOut( "Anh co mot mon qua gui tang", 16, 12, 30);
}
void t2(){
	fadeStringIn( "Cung xem do la gi nhe", 18, 13, 50);
	Sleep(2000);
	fadeStringOut( "Cung xem do la gi nhe", 18, 13, 20);
}
void t3_1(){
	rep(0,i,6){
		fadeStringIn( " ", 16, 30-i, 1, 10);		
		Sleep(250);
	}
}
void t3_2(){
	fadeStringIn( "Phan Tien Thanh ", 16, 18, 30);
}
void t3(){
	fadeStringIn( "Happy birthday to you", 16, 12, 50);
	Sleep(1500);
	fadeStringIn( "ATP", 16, 30, 30);
	Sleep(5000);
...
void t4(){
	...
	countUp(0,22,18,17,200,50);
	countUp(0,10,18,23,500);
	countUp(0,1997,18,27,100,1,20);
	Sleep(2000);
	countUp(1997,2006,18,27,100,1,20);	
}
void runThread1(){
	thread th1(t1);
	Sleep(3000);
...
string ss[10];
void makePoem(){
	ss[0]= "Chuc mung sinh nhat em Thanh!";
	ss[1]= "Tuoi moi cham ngoan, hoc gioi, nghe loi H2 nhe";
	ss[2]= "...From Hydrogen with luv!...";
...
int main(){
	...
	fadeStringIn( "San sang chua?", 0, 50 );
	getchar();
	countDown(5,0,0,66);
